...
void d2psi_neo_hookean_dF2(Eigen::Matrix99d &ddw, Eigen::Ref<const Eigen::Matrix3d> F, double C, double D) {
  ...
  F_sub_term2 = F(1, 1)*F(2, 2) - F(1, 2)*F(2, 1);
  ddw(4, 0) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 0), F(2, 2));

  F_sub_term2 = F(1, 2)*F(2, 0) - F(1, 0)*F(2, 2);
  ddw(4, 1) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 1));

  F_sub_term2 = F(1, 0)*F(2, 1) - F(1, 1)*F(2, 0);
  ddw(4, 2) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 2), F(2, 0));

  F_sub_term2 = F(0, 2)*F(2, 1) - F(0, 1)*F(2, 2);
  ddw(4, 3) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 0));

  ddw(4, 4) = brown_pattern(F_sub_term1*F_sub_term1, F_sub_term1, F_single_term);

  F_sub_term2 = F(0, 1)*F(2, 0) - F(0, 0)*F(2, 1);
  ddw(4, 5) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 2));

  F_sub_term2 = F(0, 1)*F(1, 2) - F(0, 2)*F(1, 1);
  ddw(4, 6) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 0), F(0, 2));

  F_sub_term2 = F(0, 2)*F(1, 0) - F(0, 0)*F(1, 2);
  ddw(4, 7) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 1));

  F_sub_term2 = F(0, 0)*F(1, 1) - F(0, 1)*F(1, 0);
  ddw(4, 8) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 2), F(0, 0));
  ...
  F_sub_term2 = F(1, 1)*F(2, 2) - F(1, 2)*F(2, 1);
  ddw(5, 0) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 0), F(2, 1));

  F_sub_term2 = F(1, 2)*F(2, 0) - F(1, 0)*F(2, 2);
  ddw(5, 1) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 1), F(2, 0));

  F_sub_term2 = F(1, 0)*F(2, 1) - F(1, 1)*F(2, 0);
  ddw(5, 2) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 2));

  F_sub_term2 = F(0, 2)*F(2, 1) - F(0, 1)*F(2, 2);
  ddw(5, 3) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 0));

  F_sub_term2 = F(0, 0)*F(2, 2) - F(0, 2)*F(2, 0);
  ddw(5, 4) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 1));

  ddw(5, 5) = brown_pattern(F_sub_term1*F_sub_term1, F_sub_term1, F_single_term);

  F_sub_term2 = F(0, 1)*F(1, 2) - F(0, 2)*F(1, 1);
  ddw(5, 6) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 0), F(0, 1));

  F_sub_term2 = F(0, 2)*F(1, 0) - F(0, 0)*F(1, 2);
  ddw(5, 7) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 1), F(0, 0));

  F_sub_term2 = F(0, 0)*F(1, 1) - F(0, 1)*F(1, 0);
  ddw(5, 8) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 2));
  ...
  F_sub_term2 = F(1, 1)*F(2, 2) - F(1, 2)*F(2, 1);
  ddw(6, 0) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 0));

  F_sub_term2 = F(1, 2)*F(2, 0) - F(1, 0)*F(2, 2);
  ddw(6, 1) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 1), F(1, 2));

  F_sub_term2 = F(1, 0)*F(2, 1) - F(1, 1)*F(2, 0);
  ddw(6, 2) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 2), F(1, 1));

  F_sub_term2 = F(0, 2)*F(2, 1) - F(0, 1)*F(2, 2);
  ddw(6, 3) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 0));

  F_sub_term2 = F(0, 0)*F(2, 2) - F(0, 2)*F(2, 0);
  ddw(6, 4) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 1), F(0, 2));

  F_sub_term2 = F(0, 1)*F(2, 0) - F(0, 0)*F(2, 1);
  ddw(6, 5) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 2), F(0, 1));

  ddw(6, 6) = brown_pattern(F_sub_term1*F_sub_term1, F_sub_term1, F_single_term);

  F_sub_term2 = F(0, 2)*F(1, 0) - F(0, 0)*F(1, 2);
  ddw(6, 7) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 1));

  F_sub_term2 = F(0, 0)*F(1, 1) - F(0, 1)*F(1, 0);
  ddw(6, 8) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 2));
  ...
  F_sub_term2 = F(1, 1)*F(2, 2) - F(1, 2)*F(2, 1);
  ddw(7, 0) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 0), F(1, 2));

  F_sub_term2 = F(1, 2)*F(2, 0) - F(1, 0)*F(2, 2);
  ddw(7, 1) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 1));

  F_sub_term2 = F(1, 0)*F(2, 1) - F(1, 1)*F(2, 0);
  ddw(7, 2) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 2), F(1, 0));

  F_sub_term2 = F(0, 2)*F(2, 1) - F(0, 1)*F(2, 2);
  ddw(7, 3) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 0), F(0, 2));

  F_sub_term2 = F(0, 0)*F(2, 2) - F(0, 2)*F(2, 0);
  ddw(7, 4) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 1));

  F_sub_term2 = F(0, 1)*F(2, 0) - F(0, 0)*F(2, 1);
  ddw(7, 5) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 2), F(0, 0));

  F_sub_term2 = F(0, 1)*F(1, 2) - F(0, 2)*F(1, 1);
  ddw(7, 6) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 0));

  ddw(7, 7) = brown_pattern(F_sub_term1*F_sub_term1, F_sub_term1, F_single_term);

  F_sub_term2 = F(0, 0)*F(1, 1) - F(0, 1)*F(1, 0);
  ddw(7, 8) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 2));
  ...
  F_sub_term2 = F(1, 1)*F(2, 2) - F(1, 2)*F(2, 1);
  ddw(8, 0) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 0), F(1, 1));

  F_sub_term2 = F(1, 2)*F(2, 0) - F(1, 0)*F(2, 2);
  ddw(8, 1) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 1), F(1, 0));

  F_sub_term2 = F(1, 0)*F(2, 1) - F(1, 1)*F(2, 0);
  ddw(8, 2) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(0, 2));

  F_sub_term2 = F(0, 2)*F(2, 1) - F(0, 1)*F(2, 2);
  ddw(8, 3) = negative_orange_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 0), F(0, 1));

  F_sub_term2 = F(0, 0)*F(2, 2) - F(0, 2)*F(2, 0);
  ddw(8, 4) = negative_red_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 1), F(0, 0));

  F_sub_term2 = F(0, 1)*F(2, 0) - F(0, 0)*F(2, 1);
  ddw(8, 5) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(1, 2));

  F_sub_term2 = F(0, 1)*F(1, 2) - F(0, 2)*F(1, 1);
  ddw(8, 6) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 0));

  F_sub_term2 = F(0, 2)*F(1, 0) - F(0, 0)*F(1, 2);
  ddw(8, 7) = yellow_blue_green_pattern(F_sub_term1*F_sub_term2, F_sub_term1, F_sub_term2, F_single_term, F(2, 1));

  ddw(8, 8) = brown_pattern(F_sub_term1*F_sub_term1, F_sub_term1, F_single_term);
}